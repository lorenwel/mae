...
def get_args_parser():
    ...
    parser.add_argument('--save_weights_every_n_epochs', default=20, type=int,
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and (epoch % args.save_weights_every_n_epochs == 0 or epoch + 1 == args.epochs):
            misc.save_model(
